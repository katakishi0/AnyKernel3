...
cp ${HOME}/android_kernel_samsung_m23xq/out/arch/arm64/boot/Image ./
cp ${HOME}/android_kernel_samsung_m23xq/out/arch/arm64/boot/dtbo.img ./dtbo
cp ${HOME}/android_kernel_samsung_m23xq/out/arch/arm64/boot/dts/vendor/qcom/lagoon.dtb ./dtb
